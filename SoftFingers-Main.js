...
// Navigation tab switching
 ...
 const WORDS = {
  ...
  Intermediate: [
  'because','between','always','almost','around','before','after','again','another','answer','beautiful','believe','better','beyond','brother','brought','building','careful','center','chance','change','choose','circle','clothes',
  'country','course','cousin','create','decide','develop','different','direction','discover','doctor','during','eight','enough','especially','example','family','favorite','feeling','finish','follow','forgot','forward','happen',
  ...
  'problem','question','quickly','reason','remember','return','school','season','second','sentence','several','should','sister','something','sometimes','special','station','story','strange','student','study','subject','sudden',
  'summer','teacher','through','together','tonight','tomorrow','understand','village','weather','weekend','window','without','wonder','world','writing','yellow','accident','advice','ancient','anybody','arrive','artist','attempt',
  'battle','beautifully','belong','border','breathe','bridge','butterfly','captain','carefully','celebrate','certain','climate','collect','command','company','complete','consider','contain','control','correct','courage','damage',
  'december','delicious','describe','destroy','developed','diamond','difference','discuss','education','electric','emergency','energy','enjoy','enough','escape','experience','explain','famous','feather','festival','future','garden',
  'general','government','grocery','history','holiday','hospital','imagine','include','information','island','knowledge','language','library','message','mountain','natural','necessary','neither','occasion','opinion','package','pattern',
  'peaceful','performance','perfect','perhaps','physical','planet','pleasure','polite','popular','position','positive','possible','powerful','prepare','present','prevent','private','produce','promise','protect','provide','purpose',
  'quality','quietly','quickness','rainbow','realize','receive','recognize','recommend','record','refresh','region','regular','relation','relax','release','remember','replace','report','require','respect','respond','result','return',
  'reward','safety','satisfy','science','seasonal','secret','secure','sensible','sentence','separate','serious','service','shadow','shelter','shining','shoulder','silence','similar','simple','single','situation','society','solution',
  'someone','something','sometimes','somewhere','southern','specialist','speech','spirit','station','strength','stretch','student','subject','success','suggest','summer','support','surface','surprise','surround','system','teacher',
  'technical','temperature','together','tomorrow','tonight','traffic','training','translate','transport','trouble','trust','understand','uniform','universe','unknown','unusual','useful','usually','valuable','variety','vehicle',
  'village','visitor','victory','weather','welcome','western','whisper','wonderful','wooden','working','writing','yourself','yesterday','adventure','behavior','birthday','bicycle','breathe','building','capture','careless','carrier',
  'century','channel','chapter','comfort','compare','concert','connect','contain','courage','curious','custom','damage','decide','deliver','demand','depend','describe','detail','difference','disappear','discover','disease',
  'education','election','emotion','employer','encourage','engineer','enjoyment','enough','entrance','environment','escape','especially','evidence','example','exercise','explain','factory','famous','fashion','feature','festival',
  'finally','foreign','freedom','friendly','function','future','gallery','general','governor','handsome','healthy','holiday','honest','imagine','improve','increase','independent','individual','industry','influence','information',
  'instrument','interest','journey','language','laughter','library','machine','manage','manner','material','measure','medicine','memory','mention','message','method','mirror','moment','movement','musical','natural','necessary',
  'neighbor','normal','notice','object','officer','opinion','opposite','ordinary','original','package','paragraph','partner','passenger','pattern','peaceful','perfect','personal','picture','pleasure','pollution','popular','position',
