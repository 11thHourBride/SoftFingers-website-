    ...
    beginner: {
      ...
      lessons: [
        // Home Row - Left Hand (Tutorials)
        {
          id: "b0",
          number: 0,
          title: "Introduction to Touch Typing -  A S D F J K L ;",
          description: "Learn the basics of touch typing",
          type: "tutorial",
          keys: ["a", "s", "d", "f", "j", "k", "l", ";"],
          text: "asdf jkl; asdf jkl; asdf jkl; asdf jkl;",
          instructions: "Touch typing is a method of typing without looking at the keyboard. Your fingers should rest on the home row keys: A, S, D, F for the left hand and J, K, L, ; for the right hand. This lesson will guide you through learning these keys step-by-step.",
          targetWPM: null,
          targetAccuracy: null,
          exercises: 0
        },
